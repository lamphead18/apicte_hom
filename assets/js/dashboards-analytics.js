...
(function () {
  ...
  if (dt_projects_table.length) {
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="javascript:;" class="dropdown-item">Detalhes</a>' +
              '<a href="javascript:;" class="dropdown-item">Arquivo</a>' +
              '<div class="dropdown-divider"></div>' +
              '<a href="javascript:;" class="dropdown-item text-danger delete-record">Excluir</a>' +
              '</div>' +
              '</div>'
            );
          }
    ...
    $('div.head-label').html('<h5 class="card-title mb-0">Notas Fiscais Eletrônicas</h5>');
  }
